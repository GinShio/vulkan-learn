...
function(target_add_window_library
  ...
  if(WINDOW_LIB_GLFW)
    ...
    target_include_directories(${TARGET_NAME} ${WINDOW_LIB_PROPERTY} ${GLFW_INCLUDE_DIRS})
    ...
    target_compile_definitions(${TARGET_NAME} ${WINDOW_LIB_PROPERTY} GLFW_INCLUDE_VULKAN)
  endif()
  if(WINDOW_LIB_SDL)
    pkg_search_module(SDL REQUIRED IMPORTED_TARGET sdl2)
    target_include_directories(${TARGET_NAME} ${WINDOW_LIB_PROPERTY} ${SDL_INCLUDE_DIRS})
    ...
    if(WIN32)
      target_compile_definitions(${TARGET_NAME} ${WINDOW_LIB_PROPERTY} SDL_MAIN_HANDLED)
    endif()
  endif()
endfunction()
